                 ...
                 <input type="hidden" id="from" name="from" value="series">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                     ...
                     <div class="col-sm-2">
                      <button type="submit" id="import_show_btn" class="btn btn-primary waves-effect waves-light text-uppercase mt-1 pt-2 pb-2 pl-3 pr-3" @if(!getcong('omdb_api_key')) disabled @endif> {{trans('words.fetch')}} </button>                      
                    </div>
                 ...
                 {!! Form::open(array('url' => array('admin/series/add_edit_series'),'class'=>'form-horizontal','name'=>'series_form','id'=>'series_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row" id="display_poster_img" style="display: none;">
                    ...
                    <div class="col-sm-8">   
                           ...
                           <img id="imdb_poster_image" src="" alt="video poster" class="img-thumbnail" width="350">                       
                    </div>
                  </div>
